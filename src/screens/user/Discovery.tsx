    ...
    <div style={{ padding: 10 }}>
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <p className="text-white-50 mb-4" style={{ maxWidth: "500px" }}>
                Every product is scored by demand, profit margin, competition
                level & return rate — so you only list products built to sell.
              </p>
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div className="search-products input-group w-50 shadow-sm rounded">
          ...
          <input
            type="text"
            className="form-control bg-white border-0 shadow-none py-2"
            placeholder="Search products..."
          />
        </div>

        <div className="btn-group shadow-sm bg-white rounded p-1" role="group">
          <button className="btn btn-white border-0 text-muted px-3">
            <i className="bi bi-funnel me-1"></i>
          </button>
          <button className="btn btn-orange rounded text-white px-3 fw-medium">
            Demand
          </button>
          <button className="btn btn-white border-0 text-muted px-3 fw-medium">
            Profit
          </button>
          <button className="btn btn-white border-0 text-muted px-3 fw-medium">
            Sales
      ...
      <div className="category-pills d-flex gap-2 mb-4 overflow-auto pb-2">
        <button className="btn btn-orange rounded-pill px-4 fw-medium">
          All
        </button>
        <button className="btn btn-white shadow-sm border rounded-pill px-4 text-dark fw-medium">
          Home
        </button>
        <button className="btn btn-white shadow-sm border rounded-pill px-4 text-dark fw-medium">
          Beauty
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        <div className="fw-medium text-dark">
          <span className="fw-bold">6</span> products available to list
        </div>
        <div className="text-muted" style={{ fontSize: "0.85rem" }}>
          <i className="bi bi-check-circle text-success me-1"></i> All products
          quality-checked
        </div>
      </div>
        ...
        {products.map((product) => (
          <div className="col-12 col-md-6 col-lg-4" key={product.id}>
            <div className="card product-card border-0 shadow-sm h-100 rounded-4 overflow-hidden bg-white">
              {/* Image Section */}
              <div
                className={`card-img-top position-relative placeholder-img ${product.imageClass}`}
              >
                ...
                <button
                  className="btn btn-light position-absolute top-0 end-0 m-3 rounded-circle p-2 shadow-sm d-flex align-items-center justify-content-center"
                ...
                <div className="position-absolute bottom-0 start-0 m-3 badge bg-dark bg-opacity-75 text-white px-2 py-1 d-flex align-items-center gap-1">
                  <i className="bi bi-graph-up-arrow text-success"></i> Demand{" "}
                  {product.demand}/100
                </div>
              </div>
