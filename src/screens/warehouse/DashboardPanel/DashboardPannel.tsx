...
const navLinks: NavLink[] = [
  { name: "Dashboard", icon: "📊", path: "/warehouse" },
  { name: "Orders", icon: "📋", path: "/warehouse/orders" },
  { name: "Flagged Orders", icon: "🚩", path: "/warehouse/flaggedOrders" },
  { name: "Scan Orders", icon: "📦", path: "/warehouse/scanOrders" },
  { name: "Products", icon: "📦", path: "/warehouse/Products" },
  { name: "Product Packs", icon: "🎁", path: "/warehouse/ProductPacks" },
  { name: "NDR", icon: "🚚", path: "/warehouse/NDR" },
  { name: "Finance", icon: "💰", path: "/warehouse/Finance" },
  { name: "Warehouse", icon: "🏬", path: "/warehouse/Warehouses" },
  { name: "SignOut", icon: "🚪" },
];


const WarehouseDashboardPanel: React.FC = () => {
