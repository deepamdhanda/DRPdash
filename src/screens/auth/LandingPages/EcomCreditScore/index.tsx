        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
              Reduce RTO by <span className="text-gradient-orange">40%</span>{" "}
              with AI-Powered Credit Scoring
            </h1>

            <p className="text-lg lg:text-xl text-white/60 mb-8 max-w-xl mx-auto lg:mx-0">
              Stop losing money to failed COD deliveries. OrderzUp analyzes
              customer behavior patterns to predict which orders will be
  ...
  const problems = [
    {
      ...
      description:
        "Indian D2C brands lose crores every year to returned orders",
      color: "hsl(0, 84%, 60%)",
        ...
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl p-8 lg:p-12 text-center card-shadow-xl">
            ...
            <p className="text-[hsl(220,9%,46%)] mb-6">
              We'll analyze the data and send you the credit score report to
              your email within 2 minutes.
            </p>
            <button
              onClick={() => {
                /* Lines 608-611 omitted */
              }}
    ...
    <section id="how-it-works" className="py-20 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-[hsl(220,47%,11%)] mb-6">
            Go Live in{" "}
            <span className="text-[hsl(24,95%,53%)]">3 Simple Steps</span>
          </h2>
          <p className="text-lg text-[hsl(220,9%,46%)] max-w-2xl mx-auto">
    ...
    <section id="benefits" className="py-20 lg:py-32 bg-[hsl(220,14%,96%)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-[hsl(220,47%,11%)] mb-6">
            Why Brands{" "}
            <span className="text-[hsl(24,95%,53%)]">Love OrderzUp</span>
          </h2>
          <p className="text-lg text-[hsl(220,9%,46%)] max-w-2xl mx-auto">
    ...
    <section id="testimonials" className="py-20 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-[hsl(220,47%,11%)] mb-6">
            Trusted by{" "}
            <span className="text-[hsl(24,95%,53%)]">500+ Brands</span>
          </h2>
          <p className="text-lg text-[hsl(220,9%,46%)] max-w-2xl mx-auto">
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-5xl font-bold text-white mb-6">
            Ready to{" "}
            <span className="text-gradient-orange">Stop Losing Money</span> to
            RTO?
          </h2>
          <p className="text-lg text-white/60 max-w-2xl mx-auto">
            Join 500+ brands that have already reduced their RTO rates by up to
            40%. Start your free trial today.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <div className="glass-card rounded-3xl p-8 text-center">
            ...
            <p className="text-white/60 mb-6">
              Get a personalized walkthrough of OrderzUp with our team. See how
    ...
    <footer className="gradient-hero py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          {/* Line 1210 omitted */}
          <div className="md:col-span-2">/* Lines 1212-1240 omitted */</div>

          {/* Line 1242 omitted */}
          <div>/* Lines 1244-1279 omitted */</div>

          <div>/* Lines 1282-1317 omitted */</div>
        </div>
