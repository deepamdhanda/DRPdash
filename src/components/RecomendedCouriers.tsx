...
const PerformanceBar = ({
  ...
  <div className="d-flex align-items-center gap-2">
    ...
    <span style={{ fontSize: 10, fontWeight: 600, color: "#000434" }}>
      {value}
    </span>
  </div>
);
          ...
          cell: (row: any) => {
            return (
              <div style={{ padding: 10, fontSize: 12 }}>
                <PerformanceBar
                  label="Delivery"
                  value={row.delivery_performance}
                />
                ...
                <PerformanceBar
                  label="Tracking"
                  value={row.tracking_performance}
                />
          ...
          cell: (row: any) => {
            return (
              <div style={{ padding: 10, fontSize: 12 }}>
                <u>
                  {" "}
                  <b style={{ textTransform: "uppercase" }}>ZONE {row.zone}</b>
                </u>
                <br />
                    ...
                    <OverlayTrigger
                      ...
                      overlay={
                        <Tooltip id="tooltip-top">
                          18% GST on ₹{row.freight_charge + row.cod_charges} ={" "}
                          {(
                          ...
                          <br />
                          {row.other_charges -
                            (row.freight_charge + row.cod_charges) * 0.18 >
                            0 &&
                            `LM Surcharge ₹${(
                              row.other_charges -
                              (row.freight_charge + row.cod_charges) * 0.18
                ...
                return (
                  ...
                  >
                    <Button
                      variant="primary"
                      onClick={() =>
                        handleBookShipment && handleBookShipment(row._id)
                      }
                    >
                      {"Book Shipment"}
                    </Button>
